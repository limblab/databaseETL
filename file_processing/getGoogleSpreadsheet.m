function result = getGoogleSpreadsheet(DOCID)
    ...
    %csvURL = ['https://docs.google.com/spreadsheets/ccc?key=' DOCID '&output=csv&pref=2'];
    %csvURL = ['https://docs.google.com/spreadsheets/ccc?key=' DOCID '&output=csv'];
    csvURL = ['https://docs.google.com/spreadsheets/d/' DOCID '/export?format=xls'];
    %csvURL = ['https://docs.google.com/spreadsheets/d/' DOCID '/export?format=xlsx'];
